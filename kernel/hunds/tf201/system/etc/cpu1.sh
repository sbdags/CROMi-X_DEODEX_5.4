...
logi "echo 760000  > pwr_cap_limit_1"
echo 760000 > /sys/module/cpu_tegra/parameters/pwr_cap_limit_1
logi "echo 760000  > pwr_cap_limit_2"
echo 760000 > /sys/module/cpu_tegra/parameters/pwr_cap_limit_2
logi "echo 620000  > pwr_cap_limit_3"
echo 620000 > /sys/module/cpu_tegra/parameters/pwr_cap_limit_3
logi "echo 620000  > pwr_cap_limit_4"
echo 620000 > /sys/module/cpu_tegra/parameters/pwr_cap_limit_4
