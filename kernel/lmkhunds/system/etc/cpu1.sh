...
logi "echo 1300000 > pwr_cap_limit_1"
echo 1300000 > /sys/module/cpu_tegra/parameters/pwr_cap_limit_1
logi "echo 1300000 > pwr_cap_limit_2"
echo 1300000 > /sys/module/cpu_tegra/parameters/pwr_cap_limit_2
logi "echo 1300000 > pwr_cap_limit_3"
echo 1300000 > /sys/module/cpu_tegra/parameters/pwr_cap_limit_3
logi "echo 1300000 > pwr_cap_limit_4"
echo 1300000 > /sys/module/cpu_tegra/parameters/pwr_cap_limit_4
